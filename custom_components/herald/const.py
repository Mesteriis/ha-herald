...
NOTIFICATION_REGISTRY_STORAGE_KEY = f"{DOMAIN}.notification_registry"
NOTIFICATION_POLICIES_STORAGE_KEY = f"{DOMAIN}.notification_policies"
...
SERVICE_REFRESH_NOTIFICATION_REGISTRY = "refresh_notification_registry"
SERVICE_GET_NOTIFICATION_REGISTRY = "get_notification_registry"
SERVICE_GET_NOTIFICATION_POLICY = "get_notification_policy"
SERVICE_SET_NOTIFICATION_POLICY = "set_notification_policy"
SERVICE_RESET_NOTIFICATION_POLICY = "reset_notification_policy"
...
DEFAULT_MAINTENANCE_MODE_ENTITY = "input_boolean.herald_maintenance_mode_sync"
DEFAULT_MAINTENANCE_MIN_LEVEL = "critical"
FRONTEND_DIR = "frontend"
FRONTEND_BASE_URL = "/herald"
FRONTEND_MODULE_PATH = "/herald/herald-card.js"


def _frontend_module_url() -> str:
    try:
        frontend_file = Path(__file__).resolve().parent / FRONTEND_DIR / "herald-card.js"
...
FRONTEND_DASHBOARD_TITLE = "Центр уведомлений Herald"
