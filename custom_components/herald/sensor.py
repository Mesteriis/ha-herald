...
SENSORS: tuple[HeraldSensorDescription, ...] = (
    HeraldSensorDescription(
        ...
        extra_fn=lambda data: {
            ...
            "notification_registry_summary": data.get("notification_registry_summary", {}),
            "notification_registry": data.get("notification_registry", {}),
            "notification_policies": data.get("notification_policies", {}),
